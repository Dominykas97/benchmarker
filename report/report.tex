...
and \texttt{ioLatency} as well. The function of $s$ is to collect multiple
...
\begin{algorithm}
  ...
  \boxitthree{cyan}
  \mySleep{\textcolor{red}{\ioLatency}}\;
  \For{$i \leftarrow 1$ \KwTo \numRequests}{
    ...
    \If{$i < \numRequests$}{
      ...
      \ioLatency$\; \label{alg:s_plus_latency}
    }
